<template>
    ...
    <div class="modal" v-show="showModal">
      <div class="modal-content">
        ...
        <h1 class="modal-heading">Create FAQ</h1>
        <form @submit.prevent="onSubmit">
          ...
          <v-md-editor id="description" name="description" placeholder="Enter Solution" v-model="form.solution" left-toolbar="undo redo clear | h bold italic | link code | save"  @fullscreen-change="fullscreen"></v-md-editor>
          ...
          <div class="button-div">
            <button :disabled="tagErrorMessage.length > 0" type="submit" aria-label="Create FAQ">Create</button>
          </div>
